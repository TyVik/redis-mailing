...
// ResponseWriterProxy is a proxy around an http.ResponseWriter that allows you to hook
// into various parts of the response process.
type ResponseWriterProxy interface {
	http.ResponseWriter
...
func wrapWriter(w http.ResponseWriter) ResponseWriterProxy {
	_, fl := w.(http.Flusher)
...
// verify that a fancyWriter implements the right interfaces.
var (
